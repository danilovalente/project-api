...
func MapRoutes(e *echo.Echo) {
	...
	g.GET("/info", GetInfo)
g.GET("/project", GetProjectList)
g.POST("/project", CreateProject)
g.GET("/project/:projectId", GetProject)
g.PUT("/project/:projectId", UpdateProject)
g.DELETE("/project/:projectId", DeleteProject)
}